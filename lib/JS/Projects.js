...
initProjects = function () {
	...
	$('[playlink="#"]').each(function(i, element){
		element = $(element);
		let repoName = element.attr('gitRepo');
		let releaseLink = 'https://github.com/repos/' + gitHubUsername + '/' + repoName + '/releases/latest';
		element.attr('playlink', releaseLink);
	});
}
